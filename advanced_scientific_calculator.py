...
Label1 = Label(calc, text = "Scientific Calculator",fg="black",font=('arial',20,'bold','italic'))
Label1.grid(row=0, columnspan=4,column=10)
equa = "" 
equation = StringVar()
calculation = Entry(calc, textvariable = equation,fg="black",font=('arial',15,'bold'),bg="white",bd=30,width=40,justify=RIGHT)
calculation.grid(row=0, columnspan=4,column=0,pady=15)
def btnPress(num):
    global equa
    equa = equa + str(num)
    equation.set(equa)
